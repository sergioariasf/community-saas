-- ARCHIVO: check_contracts_status_fixed.sql
-- PROPÓSITO: Verificar estado completo de soporte para contratos (sin agent_type)
-- ESTADO: development
...
-- 3. Verificar todos los agentes disponibles para ver la estructura
SELECT 
    name,
    LEFT(prompt_template, 100) as prompt_preview
FROM agents 
WHERE name ILIKE '%extractor%'
ORDER BY name;
