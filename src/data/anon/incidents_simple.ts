...
export type IncidentInsert = Omit<Database['public']['Tables']['incidents']['Insert'], 'organization_id'> & {
  organization_id?: string;
};
export type IncidentUpdate = Database['public']['Tables']['incidents']['Update'];

// Obtener todas las incidencias de una comunidad (simplificado)
...
// Obtener una incidencia específica (simplificado)
